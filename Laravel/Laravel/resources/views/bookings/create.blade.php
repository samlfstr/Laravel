        ...
        <form action="{{ route('bookings.store') }}" method="POST">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <small class="form-text text-muted">The room number being
                                                        booked.</small>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <small class="form-text text-muted">The start date for the
                                                        booking.</small>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input name="end" type="date" class="form-control" required
                           placeholder="yyyy-mm-dd"/>
                    <small class="form-text text-muted">The end date for the
                                                        booking.</small>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        ...
                        <small class="form-text text-muted">If the booking is being
                                                            pre-paid.</small>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-3">
                    <button type="submit" class="btn btn-primary" style="white-space:
                    nowrap;">Add
                                                                   Reservation</button>
                </div>
                <div class="col-sm-9">
                    <a href="{{ route('bookings.index') }}" class="btn btn-secondary"
                       style="margin-left: 50px;">Cancel</a>
                </div>
            </div>
        </form>
    </div>
