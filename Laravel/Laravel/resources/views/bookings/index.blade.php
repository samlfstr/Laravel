...
@section('buttons')
    ...
    {{--When you add a route with double curly braces dont forget to add single quotes--}}

<a class="btn btn-primary" href="{{ route('bookings.create') }}" role="button">Add new
                                                                        Booking</a>
@endsection
@section('content')
    <table class="table">
